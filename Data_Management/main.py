...
def main():
    ...
    while loop: 
        ...
        # Add game to a list of favorites
        elif selection == "4":
            add_favorite()
        elif selection == "5":
        # Remove game from list of favorites
            remove_favorites()
        elif selection == "6":
        # Display favorite game of current user
            display_favorite()
        elif selection == "7":
        # End loop and prompt user to login again
            loop = False
            print("(User has logged out)")
            exit()
        else: 
            # If user used no valid functions
